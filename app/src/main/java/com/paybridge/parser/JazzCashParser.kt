...
/**
 * STUB. Nobody on this project has captured a real JazzCash payment-received notification yet,
 ...
 */
class JazzCashParser : PaymentNotificationParser {
    override val provider = Provider.JAZZCASH
    ...
    override fun parse(payload: NotificationPayload): ParseResult {
        ...
        throw NotImplementedError(
            "JazzCashParser.parse() is unimplemented — capture real samples in " +
