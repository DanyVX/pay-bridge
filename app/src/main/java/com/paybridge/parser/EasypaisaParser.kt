...
/**
 * STUB. Nobody on this project has captured a real Easypaisa payment-received notification yet,
 ...
 */
class EasypaisaParser : PaymentNotificationParser {
    override val provider = Provider.EASYPAISA
    ...
    override fun parse(payload: NotificationPayload): ParseResult {
        ...
        throw NotImplementedError(
            "EasypaisaParser.parse() is unimplemented — capture real samples in " +
